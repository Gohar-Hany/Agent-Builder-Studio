...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Kayanova Agent Studio" },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cfb36b2966c1717ef9562f28cf7b15b9/id-preview-856e3b66--8c6637a3-826f-4254-a994-d782b9226810.lovable.app-1786893174760.png",
      },
      {
        name: "twitter:image",
        content:
